...
def pickle_load(path):
    ...
    assert env_name in ["maze", "ai2thor_obj_search"]
    if env_name == "maze":
        from maze.def_graph import StateID2State, GoalID2Goal, StateID2AchievedGoalID, StateIDtoNextStateID
    elif env_name == "ai2thor_obj_search":
        from ai2thor_obj_search.def_graph import StateID2State, GoalID2Goal, StateID2AchievedGoalID, StateIDtoNextStateID
    else:
...
def save(env_name):
    if env_name == "maze":
        ...
        from ai2thor_obj_search.def_graph import StateID2State, GoalID2Goal, StateID2AchievedGoalID, \
            StateIDtoNextStateID
    else:
        raise NotImplementedError
